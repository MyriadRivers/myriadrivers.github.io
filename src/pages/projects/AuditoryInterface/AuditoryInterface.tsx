...
function AuditoryInterface() {
    const headings = ["Description", "Motivation", "Scenario", "Research", "Design", "Demo", "Evaluation"];
    ...
    return (<StyledPage>
        ...
        <div className={"projectContents"} ref={contentsRef}>
            <ProjectTitle 
                text={"Artistic Swimming Auditory Interface"} 
            ...
            >
                <p>
                    Artistic swimming, also known as synchronized swimming, is a sport that requires extreme coordination and control of the body. A figure is a movement
                ...
                <p>
                    As outlined by World Aquatics (formerly FINA), positions are judged based on factors such as the extension, angle, and elevation of different body parts,
                    such as the head, legs, or trunk. Practicing figures often involves recording videos of yourself going through different figures, 
